  ...
  const sections = [
    {
      ...
      charts: [
        ...
        {
          title:
            "Price Premium For 2024 Credits With Investment-Grade Indemnity",
          subtitle:
          ...
          plugins: {
            datalabels: {
              ...
              color: (ctx) => {
                ...
                const c =
                  ctx.dataset.borderColor || ctx.dataset.backgroundColor;
  ...
  function buildChart(grid, cfg) {
    ...
    if (isBox) {
      ...
      ds = cfg.datasets.map((d) => {
        ...
        if (o.hoverBorderColor === undefined)
          o.hoverBorderColor = o.borderColor;
        ...
        if (o.pointHoverRadius === undefined)
          o.pointHoverRadius = isBar ? 0 : 7;
