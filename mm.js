  ...
  y: {
    ...
    fmt: (v) => "$" + v.toFixed(3),
      ...
      /* ─── Residential-solar median price ─── */
      {
        ...
        subtitle:
          "§48 ITCs generated by residential (“resi”) projects generally trade at a slight discount compared to §48 ITCs from solar, wind, and battery storage. However, many resi transactions often include limits of liability on tax credit insurance ranging from 40% to 80%.",
